...
{	
	...
	public class ContactListener extends b2ContactListener
	{
		...
		override public function BeginContact(contact:b2Contact):void 
		{
			...
			{
				var contactInfo:ContactInfo = new ContactInfo(new b2Vec2(0, 0), new b2Vec2(0, 0), new b2Vec2(0, 0), new b2Vec2(0, 0), 0);
				contactManager.RaiseContactEvent(GameObject(bodyA.GetUserData()), GameObject(bodyB.GetUserData()), contactInfo);
			}
		}
		...
		override public function PostSolve(contact:b2Contact, impulse:b2ContactImpulse):void 
		{
			...
			var contactInfo:ContactInfo = new ContactInfo(p1, p2, worldManifold.m_normal.Copy(), normalImpulse, intensity);
			contactManager.RaiseContactEvent(GameObject(bodyA.GetUserData()), GameObject(bodyB.GetUserData()), contactInfo);
		}
	}
